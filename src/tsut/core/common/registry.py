"""Base class for registries in the TSUT framework. This file can be extended to include any common functionality for all registries in the TSUT framework, such as a base class for registry entries, common methods for registering and retrieving entries, etc."""
